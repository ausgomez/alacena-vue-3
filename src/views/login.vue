<template>
  <div class="block relative login-page">
    <div
      class="flex w-1/2 relative bg-white p-8 form-container shadow-md"
      style="z-index: 1; opacity: 0.95"
    >
      <!-- FORM -->
      ...
      <div class="flex flex-col flex-1 justify-center">
        <button
          class="bg-red-500 w-full text-white p-2 my-2"
          type="button"
        ...
        <button
          class="bg-gray-900 text-white w-full p-2 my-2"
          type="button"
    ...
    <div
      class="absolute right-0 bottom-0 flex justify-end"
      style="z-index: -10"
    >
      <img src="/images/login_alacena.svg" class="w-3/4 mr-6 mb-6" alt="" />
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    async loginWithProvider(provider) {
      return await this.login(null, null, provider);
    },
  },
};
</script>
